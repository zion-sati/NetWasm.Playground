...
export function browserSupportMessage(): string | undefined {
  ...
  if (typeof Worker === 'undefined' || typeof WebAssembly === 'undefined') return 'This browser lacks required worker or WebAssembly support. Try a current Chromium or Firefox browser.';

...
PUBLIC_CATALOG = {'files': {'netwasm/LICENSES/BSD-2-Clause.txt': {'bytes': 1310,
                                       ...
                                       'source': {'commit': '45c94f6a9655e733b7a00ebe2f9be1bcad4d9a33',
                                                  'kind': 'git',
 ...
 'netwasm/LICENSES/MIT.txt': {'bytes': 1078,
           ...
           'netwasm-libraries/LICENSE-MAP.md': {'bytes': 403,
                                                ...
                                                'source': {'commit': '4572c10a2904b468520f4347a11051dfc7438f5c',
                                                           'kind': 'git',
                                                           'path': 'LICENSE-MAP.md',
           ...
           'netwasm/LICENSES/LicenseRef-NetWasm-Community-1.0.txt': {'bytes': 23878,
                                                                     ...
                                                                     'source': {'commit': '45c94f6a9655e733b7a00ebe2f9be1bcad4d9a33',
                                                                                ...
                                                                                'repository': 'https://github.com/zion-sati/NetWasm'}},
           'netwasm/THIRD-PARTY-NOTICES.TXT': {'bytes': 4985,
                                               'covers': ['compiler/NetWasm.*',
                                                          'hosts/*',
                                                          'hosting/*',
                                                          'runtime/*',
                                                          'references/*'],
                                               'sha256': '93618061ff202f69cb8ffe48b657ead700a4a18cb37e2db39e5b7ef4a2af7961',
                                               'source': {'commit': '45c94f6a9655e733b7a00ebe2f9be1bcad4d9a33',
                                                          'kind': 'git',
                                                          'path': 'THIRD-PARTY-NOTICES.TXT',
                                                          'repository': 'https://github.com/zion-sati/NetWasm'}},
           'netwasm/THIRD-PARTY-NOTICES.md': {'bytes': 2729,
                                              'covers': ['compiler/NetWasm.*',
                                                         'hosts/*',
                                                         'hosting/*',
                                                         'runtime/*',
                                                         'references/*'],
                                              'sha256': '6e1a25f72baaf578a3e8119f6650892a76b48f151f5502025beb45d7b52b44b2',
                                              'source': {'commit': '45c94f6a9655e733b7a00ebe2f9be1bcad4d9a33',
                                                         'kind': 'git',
                                                         'path': 'THIRD-PARTY-NOTICES.md',
                                                         'repository': 'https://github.com/zion-sati/NetWasm'}},

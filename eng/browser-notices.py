...
PUBLIC_CATALOG = {'files': {'netwasm/LICENSES/BSD-2-Clause.txt': {'bytes': 1310,
                                       ...
                                       'source': {'commit': '306485113aa2258f408224ae9e9108931892aca9',
                                                  'kind': 'git',
 ...
 'netwasm/LICENSES/MIT.txt': {'bytes': 1078,
           ...
           'netwasm-libraries/LICENSE-MAP.md': {'bytes': 403,
                                                'covers': ['implementations/System.*',
                                                           ...
                                                           'compiler/target-*.dll',
                                                                   ...
                                                                   'compiler/_framework/NetWasm.Microsoft.Extensions.Logging.Generators.*'],
                                                'sha256': 'e6896725f2ad5a63b62755a0119e66cb8f30afb6ab8be1c6e37c82da1251c5f2',
                                                'source': {'commit': 'a836c8358cd7c05e7aa092f1b3939da7c44c2275',
                                                           'kind': 'git',
                                                           'path': 'LICENSE-MAP.md',
           ...
           'netwasm-libraries/THIRD-PARTY-NOTICES.md': {'bytes': 328,
                                                        ...
                                                        'source': {'commit': 'a836c8358cd7c05e7aa092f1b3939da7c44c2275',
                                                                   ...
                                                                   'repository': 'https://github.com/zion-sati/NetWasm.Libraries'}},
           'netwasm-libraries/UPSTREAM_PROVENANCE.md': {'bytes': 2520,
                                                        'covers': ['implementations/System.*',
                                                                   'references/System.*',
                                                                   'compiler/target-*.dll',
                                                                   'implementations/Microsoft.Extensions.*',
                                                                   ...
                                                                   'compiler/_framework/NetWasm.Microsoft.Extensions.DependencyInjection.Generator.*',
                                                                   'compiler/_framework/NetWasm.Microsoft.Extensions.Logging.Generators.*'],
                                                        'sha256': '8f9b0952a382d14443219ab53c04194d8d715c948fa5672e873e3820d4abccb7',
                                                        'source': {'commit': 'a836c8358cd7c05e7aa092f1b3939da7c44c2275',
                                                                   'kind': 'git',
                                                                   'path': 'UPSTREAM_PROVENANCE.md',
                                                                   'repository': 'https://github.com/zion-sati/NetWasm.Libraries'}},
           'netwasm/LICENSE-MAP.md': {'bytes': 2289,
                                      'covers': ['compiler/NetWasm.*',
                                                 'hosts/*',
                                                 'hosting/*',
                                                 'runtime/*',
                                                 'references/*'],
                                      'sha256': '7247efd8f4828d302b650fb36ee9da5f147b29a75d1d96ac987fe79bda36211f',
                                      'source': {'commit': '306485113aa2258f408224ae9e9108931892aca9',
                                                 'kind': 'git',
                                                 'path': 'LICENSE-MAP.md',
                                                 'repository': 'https://github.com/zion-sati/NetWasm'}},
           ...
           'netwasm/THIRD-PARTY-NOTICES.TXT': {'bytes': 4036,
                                               ...
                                               'source': {'commit': '306485113aa2258f408224ae9e9108931892aca9',
                                                          ...
                                                          'path': 'THIRD-PARTY-NOTICES.TXT',
                                                          'repository': 'https://github.com/zion-sati/NetWasm'}},
           'netwasm/THIRD-PARTY-NOTICES.md': {'bytes': 2108,
                                              'covers': ['compiler/NetWasm.*',
                                                         'hosts/*',
                                                         'hosting/*',
                                                         'runtime/*',
                                                         'references/*'],
                                              'sha256': 'e2bcaaad56b97719ef8bf1838351ea919eb1523757facf08bc2a509bf90e6879',
                                              'source': {'commit': '306485113aa2258f408224ae9e9108931892aca9',
                                                         'kind': 'git',
                                                         'path': 'THIRD-PARTY-NOTICES.md',
                                                         'repository': 'https://github.com/zion-sati/NetWasm'}},
...
def verify(folder):
    ...
    actual_catalog = normalized_catalog_files(origins['files'], True)
    expected_catalog = normalized_catalog_files(PUBLIC_CATALOG['files'], False)
    if actual_catalog != expected_catalog:
        differing = next((path for path in sorted(actual_catalog.keys() | expected_catalog.keys())
                          if actual_catalog.get(path) != expected_catalog.get(path)), '<unknown>')
        raise ValueError('Notice origins differ from the pinned public catalog: ' + differing)
    if origins.get('missingSourceNotices') != PUBLIC_CATALOG['missingSourceNotices']:
        raise ValueError('Missing-source notice list differs from the pinned public catalog')

...
class BrowserNoticeVersionTests(unittest.TestCase):
    def test_released_package_versions_follow_public_pins(self):
        ...
        self.assertEqual("0.4.0", versions["netwasm.toolchain"])
        self.assertEqual("0.4.0", versions["netwasm.tunit"])
        self.assertEqual("0.4.0", versions["netwasm.tunit.assertions"])
        self.assertEqual("0.4.0", versions["netwasm.tunit.core"])

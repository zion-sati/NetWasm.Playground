...
try {
  ...
  if (component.sha256 !== expected.component.sha256) throw Error('Generated JSON component differs from desktop');
  ...
  console.log('PASS: actual JSON generator, desktop-equal download, renamed property and edited value');
